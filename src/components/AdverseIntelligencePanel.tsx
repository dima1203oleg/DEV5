    ...
    <div className="space-y-6">
      ...
      {activeTab === 'report' && (
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Risk Gauge Box */}
            <div className="lg:col-span-1 bg-slate-950 border border-rose-900/60 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden shadow-2xl">
            ...
            <div className="lg:col-span-2 bg-slate-950/70 border border-slate-800/80 rounded-2xl p-6 flex flex-col justify-between shadow-xl">
              <div>
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-6 shadow-xl">
      ...
      {activeTab === 'timeline' && (
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-6 space-y-5 shadow-xl"
        >
      ...
      {activeTab === 'action_plan' && (
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-6 space-y-6 shadow-xl"
        >
