...
export default function DataOnboardingCenter() {
  ...
  return (
    <div className="flex flex-col gap-4 text-slate-100 font-sans">
      {/* HEADER BANNER */}
      <div className="glass-panel-premium border-slate-800 rounded-2xl p-4 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-amber-500 via-cyan-500 to-emerald-500" />
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-2xl flex-shrink-0 shadow-lg shadow-amber-500/10">
            🧠
          </div>
          <div>
      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 lg:col-span-7 glass-panel-premium border-slate-800 rounded-2xl p-4 flex flex-col gap-3 relative">
        ...
        <div className="col-span-12 lg:col-span-5 glass-panel-premium border-slate-800 rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-slate-900/90 via-slate-900 to-indigo-950/20">
          <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
            <div className="flex items-center gap-2">
      ...
      <div className="glass-panel-premium border-slate-800 rounded-2xl p-4 flex flex-col gap-3 relative overflow-hidden">
      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 lg:col-span-6 glass-panel-premium border-slate-800 rounded-2xl p-4 flex flex-col gap-3">
          <div className="flex items-center justify-between border-b border-slate-800 pb-2">
            <div className="flex items-center gap-2">
      ...
      <div className="glass-panel-premium border-slate-800 rounded-2xl p-4 flex flex-col gap-3">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2">
          <div className="flex items-center gap-2">
      ...
      <AnimatePresence>
        {pipelineFinished && createdConnector && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="glass-panel-premium border-amber-500/60 rounded-2xl p-5 bg-gradient-to-br from-slate-900 via-amber-950/20 to-slate-900 relative overflow-hidden shadow-2xl shadow-amber-500/10"
          >
