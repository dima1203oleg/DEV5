            ...
            {!isCreatingSource ? (
              <div className="col-span-12 xl:col-span-6 glass-panel-premium border-slate-800 rounded-2xl p-2 flex flex-col h-[400px] justify-between relative overflow-hidden">
                ...
                <div>
                  ...
                  <div className="bg-black/30 p-2 rounded-2xl border border-slate-800 space-y-3 mb-3">
                    ...
                    {selectedBlueprintSection === 5 && (
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 font-mono text-xs">
                          ...
                          <div className="p-3 bg-rose-950/20 border border-rose-800/40 rounded-2xl space-y-2">
                          ...
                          <div className="p-3 bg-slate-900/50 border border-slate-700/50 rounded-2xl space-y-2 mt-2">
                          ...
                          <div className="p-3 bg-[#0a0a0a] border border-slate-800 rounded-2xl space-y-2 mt-2 overflow-x-auto custom-scrollbar">
