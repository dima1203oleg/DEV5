      ...
      <div className="bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 p-2 rounded-2xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-rose-600/30 hover:bg-rose-600 border border-rose-500/50 text-xs font-bold text-rose-200 hover:text-white font-mono uppercase tracking-wider cursor-pointer transition-all shrink-0 shadow-lg shadow-rose-950/40"
